  // src/pages/Proprietarios/Imoveis/ImovelDetail/ImovelDetailPage.tsx
  // Detalhe do imóvel com abas + botão "Editar" (pill escuro) abrindo modal sobreposto.
  ...
  export default function ImovelDetailPage() {
    ...
    const isDocs = (loc.pathname as string).endsWith("/docs");
    ...
    return (
      <div className="page">
        ...
        <section className="card">
          <div className="cardhead">
            ...
            <div style={{ flex: 1 }}>
              ...
              <h2 style={{ marginBottom: 4 }}>
                {titleEndereco || `Imóvel #${titleNumero}`}
              </h2>
          ...
          {/* Conteúdo */}
          <div className="body">
            {!isDocs && !isFotos && <InfoTab imovel={imovel} />}
            {isDocs && <DocsTab />}
            {isFotos && <FotosTab />}
          </div>
